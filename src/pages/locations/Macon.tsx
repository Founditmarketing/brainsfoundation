...
export default function MaconMO() {
    return (
        <div className="bg-white min-h-screen">
            <SEO
                title="Foundation Repair in Macon, MO | Brian's Foundation Repair"
                description="Expert foundation repair, house leveling, and concrete leveling services in Macon, MO. Serving Macon County and the Highway 36/63 corridor."
            />
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    <Reveal>
                        <div className="inline-flex items-center gap-2 bg-primary-red/20 text-white px-4 py-2 rounded-full mb-6 border border-primary-red/50">
                            <MapPin size={16} />
                            <span className="text-sm font-bold uppercase tracking-wider">Serving Macon, Missouri</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-6">Expert Foundation Repair in Macon, MO</h1>
                        <p className="text-xl text-primary-gray leading-relaxed max-w-2xl mx-auto">
                            Providing structural peace of mind for homes and businesses throughout Macon County. Decades of local experience solving rural Missouri soil issues.
                        </p>
                    </Reveal>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <Reveal>
                        ...
                        <div className="space-y-6 text-lg text-primary-gray leading-relaxed">
                            <p>
                                Whether you live right in town along the Highway 63 corridor or out on acreage in Macon County, your home's foundation is constantly battling Missouri's unpredictable weather and expansive clay soils.
                            </p>
                            <p>
                                When clay soil absorbs spring rain, it swells and pushes against your basement walls. During hot, dry spells, it pulls away. This cyclical pressure causes block walls to bow, concrete slabs to sink, and drywall to crack. We diagnose these exact local issues and implement permanent structural solutions.
                            </p>
                        </div>

                        <ul className="mt-8 space-y-4">
                            {[
                                "Deeply experienced with Macon County soil variation",
                                "Fast, local response times for rural properties",
                                "Custom foundation repairs, tailored to your home"
                            ].map((sign, i) => (
                    ...
                    >
                        ...
                        <motion.div variants={fadeUp} className="bg-concrete p-8 rounded-2xl">
                            ...
                            <p className="text-primary-gray text-sm">Lifting and stabilizing older and rural homes across Northern Missouri.</p>
                        </motion.div>
                    </motion.div>
                </div>
            </section>
